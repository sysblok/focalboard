...
const AdminPage = () => {
    ...
    const [boardTemplateSelectorOpen, setBoardTemplateSelectorOpen] =
        useState<boolean>(false)
    const [changePasswordUser, setChangePasswordUser] = useState<IUser | null>(
        null,
    )
    ...
    const handleChangePassword = useCallback(
        async (userId: string, newPassword: string) => {
            try {
                const success = await octoClient.changeUserPassword(
                    userId,
                    newPassword,
                )
            ...
            <div className='panel'>
                {boardTemplateSelectorOpen && (
                    <BoardTemplateSelector
                        onClose={closeBoardTemplateSelector}
                    />
                )}
